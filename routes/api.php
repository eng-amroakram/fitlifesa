...
Route::apiResource('exercises-testing', ExerciseController::class)->only(['index', 'show']);
...
Route::group(['prefix' => 'v1', 'middleware' => ['jsonResponse', 'cors']], function () {
    ...
    Route::group(['prefix' => 'customer', 'middleware' => ['auth:user-api']], function () {
        ...
        // Questionnaire
        Route::get('questionnaires', [QuestionnaireController::class, 'getAllQuestionnaire']);
...
Route::group(['prefix' => 'v1/customer', 'middleware' => ['jsonResponse', 'cors', 'auth:user-api']], function () {
    ...
    Route::group(['prefix' => 'nutrition'], function () {
        Route::apiResource('/food-types', FoodTypeController::class)->only('index');
        Route::apiResource('/food-exchanges', FoodExchangeController::class)->only(['index']);
        Route::apiResource('/meals', \App\Http\Controllers\API\User\Nutrition\MealController::class);
